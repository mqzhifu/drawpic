<mxfile host="app.diagrams.net" modified="2021-04-10T05:42:57.041Z" agent="5.0 (Macintosh; Intel Mac OS X 10_15_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36" etag="2C9iGM3JIaPWY-avuwjk" version="14.5.7" type="github">
    ...
    <mxGraphModel dx="2066" dy="1064" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="827" pageHeight="1169" math="0" shadow="0">
      <root>
        ...
        <mxCell id="GLcWbR3M1zZIn5tLLmif-1" value="Variable object" style="swimlane;" vertex="1" parent="1">
          <mxGeometry x="520" y="1730" width="520" height="636" as="geometry" />
        </mxCell>
        <mxCell id="GLcWbR3M1zZIn5tLLmif-2" value="scopeChain" style="rounded=0;whiteSpace=wrap;html=1;" vertex="1" parent="1">
          <mxGeometry x="560" y="1527" width="120" height="60" as="geometry" />
        </mxCell>
        <mxCell id="GLcWbR3M1zZIn5tLLmif-3" value="arguments&lt;br&gt;Object" style="rounded=0;whiteSpace=wrap;html=1;" vertex="1" parent="1">
